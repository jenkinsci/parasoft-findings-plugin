 ...
 */
public final class WarningsTotalsGraphPortlet 
    extends AbstractWarningsGraphPortlet 
{
    ...
    public WarningsTotalsGraphPortlet(String name, String width, String height, String dayCountString) 
    {
    ...
    public static class WarningsGraphDescriptor extends Descriptor<DashboardPortlet> {
        ...
        {
            return Messages.PORTLET_WARNINGS_TOTALS_GRAPH;
        }
    }
}
