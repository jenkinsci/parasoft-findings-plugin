...
public final class FilePathUtil
{
    ...
    public static boolean isAbsolute(FilePath file)
    {
        ...
        } catch (IOException e) { // parasoft-suppress OWASP2021.A9.LGE "This is intentionally designed to ensure exceptions during file processing don't cause the build to fail."
