...
public class Properties {
    ...
    public static final String DOTTEST_PROJECT_COMMAND= "set \"DOTNET_HOME=C:\\Program Files\\dotnet\"\n" +
                                                        "set \"Path=%DOTNET_HOME%;\"\n" +
                                                        "\"C:/ParasoftTools/dottest/dottestcli.exe\" " +
    ...
    public static final String DOTTEST_ISSUES_ENTRIES_ASSERTATION ="1552 entries";
    public static final String DOTTEST_RULE_TYPE_ASSERTATION ="Type BD.EXCEPT.NR";
    ...
    public static final int WAIT_FOR_BUILF_FINISHED_TIMEOUT = 420 * 1000;
}
